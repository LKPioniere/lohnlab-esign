...
const FieldActionButtons = ({
  ...
  return (
    <div className="flex flex-col items-center" {...props}>
      <div className="group flex w-fit items-center justify-evenly gap-x-1.5 rounded-lg border bg-gray-900 p-1">
        <button
          title={t`Duplicate`}
          className="rounded-md p-2 text-gray-400 transition-colors hover:bg-white/10 hover:text-gray-100"
